-- ============================================================================
-- Recrear vista vw_nombres_comunes
-- Agrega nombres estándar (principal = true) por idioma desde nombre_comun,
-- una fila por especie con ficha (vw_ficha_especie_completa).
-- ============================================================================
