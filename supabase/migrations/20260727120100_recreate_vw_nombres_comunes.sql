-- Recreate vw_nombres_comunes (dropped in cascade when vw_ficha_especie_completa was dropped).
-- Same body as 20260720130000_vw_nombres_comunes_add_hierarchy.sql — kept in sync so a fresh
-- apply of the migrations still produces the current shape.
