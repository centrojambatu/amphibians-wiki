-- ============================================================================
-- vw_nombres_comunes: filtrar por vfc.publicar = true
-- La ficha_especie es la fuente de verdad. Especies con ficha no publicada
-- (publicar = false o NULL) no deben aparecer en las secciones de Nombres.
-- ============================================================================
