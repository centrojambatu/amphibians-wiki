    ...
    <div className="bg-background min-h-screen">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
          ...
          <StatCard
            caption={stats?.primer_video?.nombre_cientifico ?? null}
            label="1er video registrado"
            posterSrc={stats?.primer_video?.thumbnail ?? stats?.primer_video?.fotografia_url}
            videoSrc={stats?.primer_video?.enlace}
          />
