    ...
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8 text-center">
        ...
        <p className="text-muted-foreground mx-auto max-w-3xl text-lg">
          Ecuador ocupa el cuarto lugar en el mundo con la mayor diversidad de
          anfibios (690 especies, 353 endémicas), después de Brasil, Colombia y
          Perú.
        </p>
      </div>
      ...
      <Card className="mb-8">
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground text-sm">
            Esta publicación de Anfibios de Ecuador compila y provee una
            síntesis de la información disponible de cada una de las especies,
            al igual que material no publicado previamente (nombres comunes,
            fotografías, mapas, etc.).
          </p>
          <p className="text-muted-foreground text-sm">
            Las fichas que contienen sumarios de especies son continuamente
            actualizados por varios compiladores y editores e irán apareciendo
            en la página web cuando estén completos.
          </p>
      ...
      <div className="text-muted-foreground text-center text-sm">
        <p>
          Última actualización:{" "}
          {new Date(statistics.last_updated).toLocaleDateString("es-ES")}
        </p>
      </div>
    </main>
  );
