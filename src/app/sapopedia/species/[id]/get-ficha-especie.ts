...
export default async function getFichaEspecie(idFichaEspecie: string) {
  ...
  if (errorNombresComunes) {
    console.error("Error nombres comunes:", errorNombresComunes);
  }
  ...
  const camposTexto: (string | null)[] = [
    ...
    fichaEspecie?.descripcion_canto ?? null,
    fichaEspecie?.color_en_vida ?? null,
    fichaEspecie?.comparacion ?? null,
    fichaEspecie?.spp_similares ?? null,
  ...
  const result = {
    ...
    holotipo: fichaEspecie?.holotipo ?? null,
    ...
    spp_similares: fichaEspecie?.spp_similares ?? null,
    ...
    descripcion_canto: fichaEspecie?.descripcion_canto ?? null,
    ...
    area_ocupacion: fichaEspecie?.area_ocupacion ?? null,
