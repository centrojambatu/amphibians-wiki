        ...
        <Card>
          <CardContent>
            <p className="text-3xl font-bold sm:text-4xl">
              ...
              <span className="text-muted-foreground text-2xl font-normal sm:text-2xl">
                {especies.length > 0
                  ? ((especies.filter((e) => e.lista_roja_iucn === "CR").length / especies.length) * 100).toFixed(1)
                  : "0"}
                %
              </span>
            </p>
        ...
        <Card>
          <CardContent>
            <p className="text-3xl font-bold sm:text-4xl">
              ...
              <span className="text-muted-foreground text-2xl font-normal sm:text-2xl">
                {especies.length > 0 ? ((posiblementeExtintaCount / especies.length) * 100).toFixed(1) : "0"}%
              </span>
            </p>
            <p className="text-muted-foreground text-xs sm:text-sm">Posiblemente extinta</p>
          </CardContent>
        </Card>
      </div>
