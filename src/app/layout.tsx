...
export const metadata: Metadata = {
  title: "Amphibians wiki",
  description: "Amphibians wiki",
};
    ...
    <html lang="en">
      <body className="container m-auto grid min-h-screen grid-rows-[auto_1fr_auto] gap-8 px-4 font-sans antialiased">
        <header className="text-xl leading-[4rem] font-bold">
          <Link href="/">amphibians-wiki</Link>
        </header>
        {children}
        <footer className="text-center leading-[4rem] opacity-70">amphibians-wiki</footer>
      </body>
    </html>
  );
}
