...
export default function MapotecaStats() {
  ...
  const histogramaTitle =
    histogramMode === "biogeografico"
      ? "Especies por sector biogeográfico"
      : histogramMode === "ecosistema"
        ? "Especies por ecosistema"
        : histogramMode === "piso"
          ? "Especies por piso altitudinal"
          : histogramMode === "snap"
            ? "Especies por área protegida (SNAP)"
            : histogramMode === "endemica"
              ? "Endémicas por sector biogeográfico"
  ...
  return (
    <div className="pb-4">
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
        {/* Provincia */}
        <button
          className={`flex cursor-pointer flex-col items-center justify-center rounded-md border p-2 transition-shadow hover:shadow-md ${histogramMode === "provincias" ? "ring-2 ring-[#f07304]/70" : ""}`}
        ...
        {/* Biogeográfico */}
        <button
          className={`flex cursor-pointer flex-col items-center justify-center rounded-md border p-2 transition-shadow hover:shadow-md ${histogramMode === "biogeografico" ? "ring-2 ring-[#f07304]/70" : ""}`}
          style={{borderColor: "#dddddd"}}
          type="button"
        ...
        {/* Ecosistema */}
        <button
          className={`flex cursor-pointer flex-col items-center justify-center rounded-md border p-2 transition-shadow hover:shadow-md ${histogramMode === "ecosistema" ? "ring-2 ring-[#f07304]/70" : ""}`}
          style={{borderColor: "#dddddd"}}
          type="button"
        ...
        {/* Piso altitudinal */}
        <button
          className={`flex cursor-pointer flex-col items-center justify-center rounded-md border p-2 transition-shadow hover:shadow-md ${histogramMode === "piso" ? "ring-2 ring-[#f07304]/70" : ""}`}
          style={{borderColor: "#dddddd"}}
          type="button"
        ...
        {/* SNAP */}
        <button
          className={`flex cursor-pointer flex-col items-center justify-center rounded-md border p-2 transition-shadow hover:shadow-md ${histogramMode === "snap" ? "ring-2 ring-[#f07304]/70" : ""}`}
          style={{borderColor: "#dddddd"}}
          type="button"
